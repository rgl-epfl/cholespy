...
def test_results_compared_to_sksparse():
    ...
    np.testing.assert_array_almost_equal(x, np.array([28.58333333, -7.66666667,  1.33333333]))

    x = sparse_cholesky.solve_Lt(b)
    np.testing.assert_array_almost_equal(x, np.array([ 52., -13.,   3.]))

    x = sparse_cholesky.solve_L(b)
    np.testing.assert_array_almost_equal(x, np.array([ 1., -1., 12.]))

    x = sparse_cholesky.solve_D(b)
    np.testing.assert_array_almost_equal(x, np.array([ 0.25      , 2.        , 0.33333333]))

    x = sparse_cholesky.solve_LDLt(b)
    np.testing.assert_array_almost_equal(x, np.array([ 28.58333333, -7.66666667,  1.33333333]))

    x = sparse_cholesky.solve_DLt(b)
    np.testing.assert_array_almost_equal(x, np.array([ 0.58333333, 0.33333333, 0.33333333]))
